        ...
        <div class="max-w-5xl mx-auto px-6">
          <div class="flex items-center h-16 justify-between">
            <div class="flex items-center gap-4 w-32">
              <h1 class="text-xl font-bold text-text leading-none m-0">SVGEN</h1>
            </div>

            <div class="flex items-center gap-2">
              <a href="/" class="flex items-center gap-2 p-3 text-text-secondary transition-all duration-200 text-sm font-medium cursor-pointer border-b-2 ${this.isActive("/") ? "border-border text-text" : "border-transparent hover:text-text"}">
              ...
              <a href="/settings/" class="flex items-center gap-2 p-3 text-text-secondary transition-all duration-200 text-sm font-medium cursor-pointer border-b-2 ${this.isActive("/settings") ? "border-border text-text" : "border-transparent hover:text-text"}">
              ...
              <a href="/gallery/" class="flex items-center gap-2 p-3 text-text-secondary transition-all duration-200 text-sm font-medium cursor-pointer border-b-2 ${this.isActive("/gallery") ? "border-border text-text" : "border-transparent hover:text-text"}">
            ...
            <div class="w-32 hidden md:flex items-center justify-end">
              <a
                ...
                class="text-text-secondary transition-colors duration-200 flex items-center hover:text-text"
